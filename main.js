...
a process by which text is evaluated and improved by an application. In this project, you will create a 
miniature version of a linter using array methods that you have learned.
*/
...
betterWords.forEach(function (words) {
  if (words === 'really') {
...
console.log('Number of sentences in the paragraph:', numberOfSentences);
